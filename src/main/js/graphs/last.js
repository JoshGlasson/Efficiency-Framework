...
constructor(props) {
  super(props)
    this.state = {x: [], y: [], title: "Refresh Last Data", class: "list-group-item list-group-item-action", disabled: false, disablebutton: ""};
    ...
    fetch('/api/lasts', {
              ...
              credentials: 'same-origin'
                 ...
                 .then((json) => {
                   this.setState(state => ({x: json._embedded.lasts[0].arraySize, y: json._embedded.lasts[0].timeTaken}))
                   console.log(this.state.x + this.state.y);
                 });
  }

    changeTitle(){
      this.setState({ title: "Last Data Refreshing"});
